...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
fit.multi <- lmer(log.funded ~ sector + (1+factor(Gender.Var)|country),data=fit1.data)
#summary(fit.multi)
